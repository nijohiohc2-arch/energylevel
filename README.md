...
<head>
    ...
    <title>영혼의 지도: 의식과 에너지 인포그래픽</title>
...
<body class="selection:bg-purple-200 selection:text-purple-900">
    ...
    <header class="relative min-h-[60vh] flex flex-col justify-center items-center text-center px-4 py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto fade-in">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6 serif leading-tight">
                영혼의 지도: <br/> <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-amber-500">의식과 에너지의 흐름</span>
            </h1>
            <p class="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto font-light leading-relaxed">
                보이지 않는 것을 시각화하다. 당신의 내면 에너지 균형을 탐구하고, 의식의 성장을 위한 데이터를 확인하세요.
            </p>
    ...
    <section class="py-16 px-4 bg-white relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-2xl font-bold text-gray-800 mb-4 serif">보고서 개요: 내면의 데이터</h2>
            <p class="text-gray-600 leading-relaxed mb-8">
                이 인터랙티브 리포트는 영적인 성장과 내면의 평화를 '인포그래픽' 형태로 재해석한 것입니다. 
                추상적인 개념인 <strong>에너지(Energy), 의식(Consciousness), 균형(Balance)</strong>을 
                시각적 데이터로 변환하여, 사용자가 직관적으로 자신의 상태를 이해하고 성찰할 수 있도록 돕습니다.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                <div class="p-6 bg-purple-50 rounded-2xl">
                    <div class="text-purple-600 text-2xl mb-2">✦</div>
                    <h3 class="font-bold text-gray-800 mb-2">균형 (Balance)</h3>
                    <p class="text-sm text-gray-600">삶의 5가지 핵심 영역 간의 조화를 분석합니다.</p>
                </div>
                <div class="p-6 bg-amber-50 rounded-2xl">
                    <div class="text-amber-600 text-2xl mb-2">▲</div>
                    <h3 class="font-bold text-gray-800 mb-2">상승 (Ascension)</h3>
                    <p class="text-sm text-gray-600">의식 수준의 단계별 특징과 성장 과정을 탐구합니다.</p>
                </div>
                <div class="p-6 bg-teal-50 rounded-2xl">
                    <div class="text-teal-600 text-2xl mb-2">∞</div>
                    <h3 class="font-bold text-gray-800 mb-2">연결 (Connection)</h3>
                    <p class="text-sm text-gray-600">개인의 변화가 집단 의식에 미치는 영향을 시각화합니다.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col md:flex-row gap-12 items-start">
                ...
                <div class="w-full md:w-1/3">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4 serif">내면의 나침반</h2>
                    <p class="text-gray-600 mb-6 text-sm">
                        아래 슬라이더를 조절하여 현재 당신의 상태를 입력해보세요. 
                        오른쪽 차트가 실시간으로 변화하며 당신의 '영적 균형도'를 시각화합니다.
                    </p>
                    ...
                    <div class="space-y-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>신체 (Body)</span> <span id="val-body">70%</span>
                            </label>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>마음 (Mind)</span> <span id="val-mind">60%</span>
                            </label>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>감정 (Emotion)</span> <span id="val-emotion">50%</span>
                            </label>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>영성 (Spirit)</span> <span id="val-spirit">80%</span>
                            </label>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>관계 (Social)</span> <span id="val-social">65%</span>
                            </label>
                    ...
                    <div class="mt-6 p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                        <h4 class="font-bold text-indigo-900 text-sm mb-1">현재 상태 분석:</h4>
                    ...
                    <button id="plan-button" onclick="generateBalancePlan()" class="mt-4 w-full px-4 py-2 bg-purple-600 text-white font-bold rounded-lg shadow-lg hover:bg-purple-700 transition-colors flex items-center justify-center disabled:opacity-50" disabled>
                        <span id="plan-button-text">✨ 균형 플랜 생성</span>
                    </button>
                ...
                <div class="w-full md:w-2/3 bg-white rounded-3xl p-4 md:p-8 shadow-lg border border-gray-100 flex flex-col justify-center items-center">
                    ...
                    <p class="text-xs text-center text-gray-400 mt-4">영적 에너지 균형 다이어그램 (Spiritual Energy Balance Diagram)</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 px-4 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 serif">의식의 7단계 (The 7 Stages)</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">
                    의식은 선형적으로 성장하지 않고 나선형으로 진화합니다. 각 단계를 클릭하여 그 단계가 가진 에너지와 지혜를 탐구해보세요.
                </p>
            </div>
                ...
                <div class="relative">
                    <div class="sticky top-10 glass-card rounded-2xl p-8 transition-all duration-500" id="stage-detail-card">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h3 id="detail-title" class="text-2xl font-bold text-gray-900 serif">단계를 선택하세요</h3>
                                <p id="detail-subtitle" class="text-sm text-purple-600 font-medium">탐험을 시작하려면 왼쪽 목록을 클릭하세요</p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <p id="detail-desc" class="text-gray-600 leading-relaxed">
                                각 단계는 우리가 세상을 인식하는 렌즈와 같습니다. 낮은 단계는 생존과 안전에 집중하지만, 높은 단계로 갈수록 연결과 통합을 지향합니다.
                            </p>
                            ...
                            <button id="affirmation-button" onclick="generateAffirmation()" class="w-full px-4 py-2 bg-amber-500 text-white font-bold rounded-lg shadow-lg hover:bg-amber-600 transition-colors flex items-center justify-center text-sm disabled:opacity-50">
                                <span id="affirmation-button-text">✨ 맞춤형 성찰 생성</span>
                            </button>
                            
                            <div id="affirmation-results" class="mt-4 p-4 bg-yellow-50 rounded-xl border border-yellow-100 hidden">
                                <h4 class="text-xs font-bold text-yellow-800 mb-1">💡 오늘의 성찰</h4>
                                <p id="affirmation-content" class="text-sm text-yellow-900 italic leading-relaxed"></p>
                            </div>

                            <div>
                                <h4 class="text-sm font-bold text-gray-800 mb-2 uppercase tracking-wide">Key Attribute (핵심 속성)</h4>
                            ...
                            <div class="bg-yellow-50 p-4 rounded-xl border border-yellow-100 mt-4">
                                <h4 class="text-xs font-bold text-yellow-800 mb-1">💡 Insight (통찰)</h4>
                                <p id="detail-insight" class="text-sm text-yellow-900 italic">"모든 여정은 첫 걸음에서 시작됩니다."</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-20 px-4 bg-gray-900 text-white">
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col md:flex-row gap-12 items-center">
                ...
                <div class="w-full md:w-1/3">
                    <h2 class="text-3xl font-bold mb-4 serif text-purple-300">집단 의식의 흐름</h2>
                    <p class="text-gray-400 mb-6 leading-relaxed">
                        개인의 변화는 집단의 변화로 이어집니다. 시뮬레이션 데이터에 따르면, 명상과 내면 탐구가 증가함에 따라 사회적 스트레스 지수는 감소하고 집단 공감 지수는 상승하는 경향을 보입니다.
                    </p>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between border-b border-gray-700 pb-2">
                            <span class="text-sm text-gray-400">평균 명상 시간</span>
                            <span class="font-bold text-teal-400">▲ 24% 증가</span>
                        </div>
                        <div class="flex items-center justify-between border-b border-gray-700 pb-2">
                            <span class="text-sm text-gray-400">사회적 연결감</span>
                            <span class="font-bold text-purple-400">▲ 18% 상승</span>
                        </div>
                        <div class="flex items-center justify-between border-b border-gray-700 pb-2">
                            <span class="text-sm text-gray-400">스트레스 지수</span>
                            <span class="font-bold text-red-400">▼ 12% 감소</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-24 px-4 bg-purple-50 flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-2xl">
            <h2 class="text-3xl font-bold text-gray-900 mb-4 serif">잠시 멈춤 (Pause)</h2>
            <p class="text-gray-600 mb-8">
                모든 데이터와 정보는 결국 '지금 이 순간'의 평온함을 위한 것입니다.<br>
                원의 움직임에 맞춰 깊게 호흡해보세요.
            </p>
            ...
            <button onclick="alert('평온함을 선택하셨습니다. 오늘도 평화로운 하루 되세요.')" class="mt-8 text-sm text-purple-600 hover:text-purple-800 underline underline-offset-4 decoration-purple-300">
                이 순간을 기억하기
            </button>
        </div>
    </section>
    ...
    <script>
        ...
        const stagesData = [
            {
                ...
                icon: "🌱",
                desc: "가장 기초적인 단계입니다. 물리적 생존, 안전, 건강에 집중합니다. 두려움을 극복하고 안정감을 찾는 것이 목표입니다.",
                attributes: ["안정감", "건강", "물질적 풍요"],
                insight: "당신은 안전합니다. 대지는 당신을 지지하고 있습니다."
            },
            {
                id: 2,
                name: "2. 관계 (Flow)",
                ...
                icon: "🌊",
                desc: "감정과 창조성의 단계입니다. 타인과의 관계, 즐거움, 유연성을 배웁니다. 죄책감을 놓고 흐름에 맡기는 것이 중요합니다.",
                attributes: ["창조성", "감정 표현", "유연함"],
                insight: "감정은 물과 같습니다. 막지 말고 흐르게 두세요."
            },
            {
                id: 3,
                name: "3. 의지 (Will)",
                ...
                icon: "🔥",
                desc: "자아와 행동력의 단계입니다. 자신감, 결단력, 자존감을 확립합니다. 수치심을 넘어 자신의 힘을 긍정하세요.",
                attributes: ["자신감", "행동력", "목표 달성"],
                insight: "당신에게는 삶을 변화시킬 힘이 있습니다."
            },
            {
                id: 4,
                name: "4. 사랑 (Love)",
                ...
                icon: "💚",
                desc: "마음의 중심입니다. 조건 없는 사랑, 용서, 연민을 경험합니다. 슬픔을 치유하고 진정한 연결을 맺습니다.",
                attributes: ["용서", "연민", "평화"],
                insight: "사랑은 감정이 아니라 존재의 상태입니다."
            },
            {
                id: 5,
                name: "5. 표현 (Truth)",
                ...
                icon: "🗣️",
                desc: "진실과 소통의 단계입니다. 자신의 진실을 말하고, 타인의 진실을 경청합니다. 거짓을 버리고 정직해지세요.",
                attributes: ["정직", "소통", "자기표현"],
                insight: "당신의 목소리는 세상에 필요한 고유한 울림입니다."
            },
            {
                id: 6,
                name: "6. 직관 (Insight)",
                ...
                icon: "👁️",
                desc: "지혜와 통찰의 단계입니다. 논리를 넘어선 직관, 상상력, 비전을 봅니다. 환상을 걷어내고 본질을 봅니다.",
                attributes: ["통찰력", "지혜", "상상력"],
                insight: "눈에 보이는 것보다 보이지 않는 것이 더 많은 것을 말해줍니다."
            },
            {
                id: 7,
                name: "7. 통합 (Unity)",
                ...
                icon: "✨",
                desc: "순수 의식과 통합의 단계입니다. 모든 것이 연결되어 있음을 깨닫습니다. 분리감을 넘어선 온전함을 경험합니다.",
                attributes: ["깨달음", "초월", "일체감"],
                insight: "우리는 서로 다른 파도가 아니라 같은 바다입니다."
            }
        ];
        ...
        function initCharts() {
            ...
            balanceChartInstance = new Chart(ctxBalance, {
                type: 'radar',
                data: {
                    labels: ['신체 (Body)', '마음 (Mind)', '감정 (Emotion)', '영성 (Spirit)', '관계 (Social)'],
                    datasets: [{
                        label: '나의 에너지 균형',
            ...
            trendChartInstance = new Chart(ctxTrend, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: '집단 공감 지수 (Collective Empathy)',
        ...
        function analyzeBalance() {
            ...
            if (spread < 20 && avg > 70) {
                message = "매우 조화롭고 높은 에너지를 유지하고 계십니다. 훌륭합니다!";
            } else if (spread < 20) {
                message = "전반적인 균형은 좋으나, 전체적인 에너지 레벨을 조금 더 높여보세요.";
            } else if (state.balance.spirit > state.balance.body + 20) {
                message = "영적인 감각은 뛰어나지만, 신체(Body)와의 연결이 필요해 보입니다. 그라운딩(Grounding)이 도움이 될 수 있습니다.";
            } else if (state.balance.mind > state.balance.emotion + 20) {
                message = "이성적인 사고가 강합니다. 감정(Emotion)의 흐름을 조금 더 허용하면 더 큰 평화를 얻을 수 있습니다.";
            } else {
                message = "특정 영역에 에너지가 집중되어 있습니다. 낮은 수치의 영역을 돌보는 시간을 가져보세요.";
            }
        ...
        async function generateAffirmation() {
            ...
            btn.disabled = true;
            btnText.innerText = '생성 중... (잠시만 기다려주세요)';
            resultContent.innerHTML = '<span class="text-gray-500">지혜를 불러오는 중입니다...</span>';
            resultBox.classList.remove('hidden');

            const systemPrompt = "당신은 영적인 가이드입니다. 현재 사용자는 한국어 사용자이며, 이 단계의 핵심 설명과 통찰을 바탕으로, 이 단계를 더 깊이 이해하고 통합할 수 있도록 돕는 한국어 맞춤형 '단락 성찰 메시지' 또는 '구체적인 수행 지침'을 생성해주세요. 다른 서론이나 결론 없이 요청된 내용만 제공하고, 존댓말을 사용하세요.";
            
            const userQuery = `현재 탐색 단계: ${stage.name} (${stage.icon}). 이 단계의 핵심 설명: "${stage.desc}" 통찰: "${stage.insight}". 이 정보를 기반으로 개인화된 성찰 메시지를 100자 내외로 생성해주세요.`;
            ...
            try {
                ...
                const text = result.candidates?.[0]?.content?.parts?.[0]?.text || "죄송합니다. 영적인 지혜를 불러오지 못했습니다. 다시 시도해 주세요.";
                
                resultContent.innerHTML = text.replace(/\n/g, '<br>');

            } catch (error) {
                console.error("Gemini API Error for Affirmation:", error);
                resultContent.innerHTML = "API 호출 중 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.";
            } finally {
                btn.disabled = false;
        ...
        async function generateBalancePlan() {
            ...
            const originalText = btnText.innerText;
            btn.disabled = true;
            btnText.innerText = '계획 분석 중...';
            resultContent.innerHTML = '<span class="text-gray-500">데이터를 바탕으로 계획을 수립 중입니다...</span>';
            resultBox.classList.remove('hidden');

            const balanceStr = Object.entries(state.balance).map(([k, v]) => `${k}:${v}`).join(', ');
            
            const systemPrompt = "당신은 전문적인 라이프 코치이자 영성 상담가입니다. 사용자의 현재 영적 에너지 균형 데이터를 바탕으로 가장 낮은 두 영역과 가장 높은 영역 간의 조화를 이루기 위한 실질적인 행동 계획(3가지)을 불릿 포인트로 작성해주세요. 응답은 한국어로 작성하고, 다른 설명 없이 번호가 매겨진 불릿 포인트 리스트(예: 1. [내용])만 제공하세요. 존댓말을 사용하세요.";
            
            const userQuery = `사용자의 현재 에너지 균형은 다음과 같습니다: ${balanceStr}. 이 데이터를 기반으로 한 맞춤형 행동 계획 3가지를 생성해주세요.`;
            ...
            try {
                ...
                const result = await response.json();
                let text = result.candidates?.[0]?.content?.parts?.[0]?.text || "죄송합니다. 행동 계획을 생성하지 못했습니다. 다시 시도해 주세요.";
                ...
                const planItems = text.split('\n').map(line => {
                    if (line.trim().startsWith('1.') || line.trim().startsWith('2.') || line.trim().startsWith('3.') || line.trim().startsWith('-')) {
                        return `<p class="flex items-start"><span class="mr-2 text-purple-500 font-bold">•</span><span>${line.replace(/^[0-9]\.\s*/, '').replace(/^-+\s*/, '')}</span></p>`;
                    }
                    return '';
                }).join('');
                
                resultContent.innerHTML = planItems || `<p class="text-red-500">계획 포맷 오류: LLM 응답을 해석할 수 없습니다. 다시 시도해 주세요.</p>`;
